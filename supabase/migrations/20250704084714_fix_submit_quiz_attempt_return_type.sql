...
BEGIN
    -- 1. Periksa apakah siswa sudah pernah mengerjakan kuis ini
    ...
    -- 2. Hitung skor dasar dan buat breakdown hasil
    FOR rec IN
        SELECT
            q.id AS question_id,
            q.question_text,
    ...
    -- 5. Masukkan hasil ke tabel quiz_attempts
