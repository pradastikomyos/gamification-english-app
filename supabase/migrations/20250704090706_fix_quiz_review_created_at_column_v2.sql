...
DROP FUNCTION IF EXISTS public.get_quiz_review_details(uuid);

-- Create the corrected RPC function that uses completed_at instead of created_at
...
BEGIN
    ...
    ORDER BY completed_at DESC  -- Menggunakan completed_at bukan created_at
    LIMIT 1;
    ...
    SELECT
        ...
        v_attempt.completed_at AS submitted_at, -- Menggunakan completed_at bukan created_at
        v_questions;
END;
$$;
